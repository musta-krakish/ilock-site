...
export const ui = {
	ru: {
		nav: { catalog: 'Каталог', about: 'О нас', partners: 'Партнёрам', contact: 'Контакты', faq: 'Частые вопросы', installDelivery: 'Установка и доставка', order: 'Оставить заявку' },
		hero: {
			...
			sections: [
				{
					...
					text: 'Для того чтобы мы могли заранее оценить возможность установки и подобрать подходящий вариант, вам нужно отправить 3 фотографии вашей двери:',
					items: [
						'Лицевая сторона двери — общий вид двери снаружи.',
						'Торцевая сторона — фотография торца двери, где находится язычок/замок. Важно, чтобы было хорошо видно существующий механизм и размеры, если они указаны.',
						'Внутренняя сторона двери — общий вид двери со стороны помещения.',
					],
					outro: [
						'После получения фотографий менеджер передаёт информацию монтажнику. Специалист оценивает конструкцию двери, тип и сложность установки и определяет, какой вариант монтажа подойдёт именно для вашей двери.',
						'В некоторых случаях для установки может потребоваться дополнительная доработка двери или замена/адаптация существующего механизма — это также определяется после оценки.',
						'После оценки мы согласовываем с вами стоимость и время установки, и монтажник приезжает уже подготовленным к работе.',
					],
				},
				{
					title: 'Доставка',
	...
	kk: {
		nav: { catalog: 'Каталог', about: 'Біз туралы', partners: 'Серіктестерге', contact: 'Байланыс', faq: 'Жиі сұрақтар', installDelivery: 'Орнату және жеткізу', order: 'Өтінім қалдыру' },
		hero: {
			...
			sections: [
				{
					...
					text: 'Орнату мүмкіндігін алдын ала бағалап, қолайлы нұсқаны таңдауымыз үшін бізге есігіңіздің 3 фотосуретін жіберуіңіз қажет:',
					items: [
						'Есіктің сыртқы жағы — есіктің сырттан жалпы көрінісі.',
						'Есіктің қыры — тілше/құлып орналасқан есік қырының фотосуреті. Қолданыстағы механизм және көрсетілген болса, өлшемдер анық көрінгені маңызды.',
						'Есіктің ішкі жағы — есіктің бөлме жағынан жалпы көрінісі.',
					],
					outro: [
						'Фотосуреттерді алғаннан кейін менеджер ақпаратты орнатушыға береді. Маман есіктің конструкциясын, орнатудың түрі мен күрделілігін бағалап, дәл сіздің есігіңізге қандай монтаж нұсқасы қолайлы екенін анықтайды.',
						'Кейбір жағдайларда орнату үшін есікті қосымша өңдеу немесе қолданыстағы механизмді ауыстыру/бейімдеу қажет болуы мүмкін — бұл да бағалаудан кейін анықталады.',
						'Бағалаудан кейін орнатудың құны мен уақытын сізбен келісеміз, сөйтіп орнатушы жұмысқа дайын күйде келеді.',
					],
				},
				{
					title: 'Жеткізу',
		...
		catalogFilters: {
			...
			sort: 'Сұрыптау',
			sortOptions: [
				{ value: 'default', label: 'Алдымен танымал' },
				{ value: 'price-asc', label: 'Алдымен арзаны' },
				{ value: 'price-desc', label: 'Алдымен қымбаты' },
				{ value: 'name', label: 'Атауы бойынша' },
			],
			found: 'Табылды',
			show: 'Көрсету',
			...
			sections: [
				{
					...
					text: 'So that we can assess the installation in advance and choose the right option, please send us 3 photos of your door:',
					items: [
						'Front of the door — a general view of the door from the outside.',
						'Edge of the door — a photo of the door edge where the latch/lock sits. It is important that the existing mechanism and any marked dimensions are clearly visible.',
						'Inside of the door — a general view of the door from inside the room.',
					],
					outro: [
						'Once we have the photos, the manager passes the information to the installer. The specialist assesses the door structure, the type and complexity of the installation, and determines which mounting option suits your door.',
						'In some cases the installation may require extra work on the door or replacing/adapting the existing mechanism — this is also determined after the assessment.',
						'After the assessment we agree the cost and time of the installation with you, and the installer arrives already prepared for the job.',
					],
				},
				{
					title: 'Delivery',
