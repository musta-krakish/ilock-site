...
export const ui = {
	ru: {
		nav: { catalog: 'Каталог', about: 'О компании', partners: 'Партнёрам', contact: 'Контакты', faq: 'Частые вопросы', installDelivery: 'Установка и доставка', order: 'Оставить заявку' },
		hero: {
		...
		company: {
			eyebrow: 'О компании',
			trustLabel: 'iLock · доверие',
			trustText: 'Подбираем решения для дома, бизнеса и объектов.',
			trustNote: 'Сертификаты и отзывы партнёров',
			pageTitle: 'О компании iLock',
			pageDescription: 'iLock — поставка и профессиональный монтаж электронных замков в Казахстане. Документы, благодарности партнёров и сертификаты.',
			title: 'Безопасность, подтверждённая',
			titleAccent: 'делом',
			text: 'iLock поставляет и профессионально устанавливает электронные замки для квартир, домов и коммерческих объектов. Работаем с частными клиентами и корпоративными партнёрами по Казахстану.',
			facts: [
				{ t: 'Поставка и монтаж', d: 'Подбираем замок, доставляем и настраиваем его на объекте.' },
				{ t: 'Опыт на объектах', d: 'Партнёры отмечают качество поставок и оперативность монтажа.' },
				{ t: 'Открыто о документах', d: 'Показываем благодарственные письма и сертификаты.' },
			],
			documents: 'Документы и благодарности',
			documentItems: [
				'Благодарность Kappas Group',
				'Знак качества «Выбор страны 2022»',
				'Благодарность «Мансур-Строй С»',
				'Благодарность Kappas Group · Sai Park House',
				'Авторизационное письмо Philips',
				'Сертификат дистрибьютора EZVIZ · 2022',
			],
		},
		partners: {
			eyebrow: 'Партнёрам',
			pageTitle: 'Партнёрам iLock',
			pageDescription: 'Решения iLock для застройщиков, гостиниц и спортивных объектов: подбор электронных замков, поставка и монтаж.',
			projects: 'Жилые комплексы в портфолио',
			projectsText: '24 объекта, для которых iLock поставлял и устанавливал электронные замки.',
			title: 'Решения для',
			titleAccent: 'вашего объекта',
			text: 'Подбираем электронные замки и организуем поставку с установкой для объектов разного формата.',
			presentation: 'Смотреть презентацию',
			items: [
				{
					eyebrow: 'Для застройщиков',
					title: 'Жилые комплексы',
					text: 'Комплексная поставка и установка электронных замков для квартир и общих зон.',
					facts: ['24 жилых комплекса в портфолио', 'Подбор моделей и монтаж под проект'],
					message: 'Здравствуйте! Хочу обсудить поставку и установку электронных замков для жилого комплекса.',
				},
				{
					eyebrow: 'Для гостиниц',
					title: 'Отели и апартаменты',
					text: 'Электронные замки для отелей, апартаментов и гостевых объектов.',
					facts: ['Решения для номеров и общих зон', 'Удобные способы доступа для гостей'],
					message: 'Здравствуйте! Хочу подобрать электронные замки для отеля или апартаментов.',
				},
				{
					eyebrow: 'Для спортивных объектов',
					title: 'Спортзалы и клубы',
					text: 'Решения для раздевалок, кабинетов и служебных помещений спортивных объектов.',
					facts: ['Доступ для посетителей и персонала', 'Подбор решения под формат объекта'],
					message: 'Здравствуйте! Хочу подобрать электронные замки для спортивного объекта.',
				},
			],
			cta: 'Обсудить проект',
		},
	...
	kk: {
		nav: { catalog: 'Каталог', about: 'Компания туралы', partners: 'Серіктестерге', contact: 'Байланыс', faq: 'Жиі сұрақтар', installDelivery: 'Орнату және жеткізу', order: 'Өтінім қалдыру' },
		hero: {
		...
		company: {
			...
			trustLabel: 'iLock · сенім',
			trustText: 'Үйге, бизнеске және нысандарға арналған шешімдерді таңдаймыз.',
			trustNote: 'Сертификаттар және серіктестер пікірлері',
			pageTitle: 'iLock компаниясы туралы',
			pageDescription: 'iLock — Қазақстанда электрондық құлыптарды жеткізу және кәсіби орнату. Құжаттар, серіктестердің алғыс хаттары және сертификаттар.',
			title: 'Іспен дәлелденген',
			titleAccent: 'қауіпсіздік',
			text: 'iLock пәтерлерге, үйлерге және коммерциялық нысандарға электрондық құлыптарды жеткізіп, кәсіби түрде орнатады. Қазақстан бойынша жеке клиенттермен және корпоративтік серіктестермен жұмыс істейміз.',
			facts: [
				{ t: 'Жеткізу және монтаж', d: 'Құлыпты таңдап, жеткізіп, нысанда баптаймыз.' },
				{ t: 'Нысандардағы тәжірибе', d: 'Серіктестер жеткізу сапасы мен жедел монтажды атап өтеді.' },
				{ t: 'Құжаттар ашық', d: 'Алғыс хаттар мен сертификаттарды көрсетеміз.' },
			],
			documents: 'Құжаттар мен алғыс хаттар',
			documentItems: [
				'Kappas Group алғыс хаты',
				'«Ел таңдауы 2022» сапа белгісі',
				'«Мансур-Строй С» алғыс хаты',
				'Kappas Group · Sai Park House алғыс хаты',
				'Philips авторизация хаты',
				'EZVIZ дистрибьюторының сертификаты · 2022',
			],
		},
		partners: {
			eyebrow: 'Серіктестерге',
			pageTitle: 'iLock серіктестеріне',
			pageDescription: 'Құрылыс салушыларға, қонақ үйлерге және спорт нысандарына арналған iLock шешімдері: электрондық құлыптарды таңдау, жеткізу және монтаж.',
			projects: 'Портфолиодағы тұрғын үй кешендері',
			projectsText: 'iLock электрондық құлыптарды жеткізіп, орнатқан 24 нысан.',
			title: 'Нысаныңызға арналған',
			titleAccent: 'шешімдер',
			text: 'Әртүрлі форматтағы нысандарға электрондық құлыптарды таңдап, орнатумен бірге жеткізуді ұйымдастырамыз.',
			presentation: 'Презентацияны қарау',
			items: [
				{ eyebrow: 'Құрылыс салушыларға', title: 'Тұрғын үй кешендері', text: 'Пәтерлер мен ортақ аймақтарға электрондық құлыптарды кешенді жеткізу және орнату.', facts: ['Портфолиода 24 тұрғын үй кешені', 'Жобаға сай модельді таңдау және монтаж'], message: 'Сәлеметсіз бе! Тұрғын үй кешеніне электрондық құлыптарды жеткізу және орнату мәселесін талқылағым келеді.' },
				{ eyebrow: 'Қонақ үйлерге', title: 'Қонақ үйлер мен апартаменттер', text: 'Қонақ үйлерге, апартаменттерге және қонақжай нысандарға арналған электрондық құлыптар.', facts: ['Бөлмелер мен ортақ аймақтарға шешімдер', 'Қонақтарға ыңғайлы кіру тәсілдері'], message: 'Сәлеметсіз бе! Қонақ үйге немесе апартаменттерге электрондық құлыптарды таңдағым келеді.' },
				{ eyebrow: 'Спорт нысандарына', title: 'Спорт залдары мен клубтар', text: 'Спорт нысандарының киім ауыстыратын бөлмелері, кабинеттері және қызметтік үй-жайларына арналған шешімдер.', facts: ['Келушілер мен қызметкерлерге арналған кіру', 'Нысан форматына сай шешімді таңдау'], message: 'Сәлеметсіз бе! Спорт нысанына электрондық құлыптарды таңдағым келеді.' },
			],
			cta: 'Жобаны талқылау',
		},
		app: {
	...
	en: {
		nav: { catalog: 'Catalog', about: 'About', partners: 'Partners', contact: 'Contact', faq: 'FAQ', installDelivery: 'Installation and delivery', order: 'Request a call' },
		hero: {
		...
		company: {
			eyebrow: 'About us',
			trustLabel: 'iLock · trust',
			trustText: 'We select solutions for homes, businesses and properties.',
			trustNote: 'Certificates and partner testimonials',
			pageTitle: 'About iLock',
			pageDescription: 'iLock supplies and professionally installs electronic locks in Kazakhstan. Documents, partner letters of appreciation and certificates.',
			title: 'Security proven',
			titleAccent: 'in practice',
			text: 'iLock supplies and professionally installs electronic locks for apartments, homes and commercial properties. We work with private customers and corporate partners across Kazakhstan.',
			facts: [
				{ t: 'Supply and installation', d: 'We select the lock, deliver it and configure it on site.' },
				{ t: 'Experience on projects', d: 'Partners recognise the quality of our supply and prompt installation.' },
				{ t: 'Documents are open', d: 'We share letters of appreciation and certificates.' },
			],
			documents: 'Documents and letters of appreciation',
			documentItems: [
				'Kappas Group letter of appreciation',
				'“Country’s Choice 2022” quality mark',
				'“Mansur-Stroy S” letter of appreciation',
				'Kappas Group · Sai Park House letter of appreciation',
				'Philips authorisation letter',
				'EZVIZ distributor certificate · 2022',
			],
		},
		partners: {
			eyebrow: 'For partners',
			pageTitle: 'iLock for partners',
			pageDescription: 'iLock solutions for developers, hospitality and sports facilities: electronic-lock selection, supply and installation.',
			projects: 'Residential complexes in our portfolio',
			projectsText: '24 properties where iLock supplied and installed electronic locks.',
			title: 'Solutions for',
			titleAccent: 'your property',
			text: 'We select electronic locks and arrange supply with installation for properties of every format.',
			presentation: 'View presentation',
			items: [
				{ eyebrow: 'For developers', title: 'Residential complexes', text: 'Comprehensive supply and installation of electronic locks for apartments and common areas.', facts: ['24 residential complexes in our portfolio', 'Model selection and installation for your project'], message: 'Hello! I would like to discuss electronic-lock supply and installation for a residential complex.' },
				{ eyebrow: 'For hospitality', title: 'Hotels and apartments', text: 'Electronic locks for hotels, apartments and other guest accommodation.', facts: ['Solutions for rooms and common areas', 'Convenient access methods for guests'], message: 'Hello! I would like to select electronic locks for a hotel or apartments.' },
				{ eyebrow: 'For sports facilities', title: 'Gyms and clubs', text: 'Solutions for changing rooms, offices and utility rooms at sports facilities.', facts: ['Access for visitors and staff', 'A solution selected for your property'], message: 'Hello! I would like to select electronic locks for a sports facility.' },
			],
